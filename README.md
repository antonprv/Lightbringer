...
You can use standalote compiled Simple Input plugin commerciall though, and I will publish it on Fab at the end of the development, when I feel confident in its technical state and feature-completeness.
...
No sitting in project settigns like with legacy system and no file bloat (1 file per input action + 1 extra for input mapping context) like in the enchanced input. Create tables, switch between them, subscribe to any of them at any time.
