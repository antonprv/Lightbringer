...
#include "Primitives/3D/Operations/AddOperation.h"

UAddOperation::UAddOperation(const FObjectInitializer& ObjInit)
    : Super(ObjInit)
{
    FriendlyName = "Add Operation";
    FriendlyCategory = "3D Primitives Operations";
    FriendlyDescription =
        "Performs a boolean addition on any two 3D Parts given.";
    ...
    SetHLSLFilePath(
        "/Source/ExtendedShaders/Private/HLSL/Primitives/3D/Operations/AddOperation.hlsl");
}
