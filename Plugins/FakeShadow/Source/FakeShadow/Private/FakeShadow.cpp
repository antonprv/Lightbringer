...
#define LOCTEXT_NAMESPACE "FFakeShadowModule"

void FFakeShadowModule::StartupModule()
{
...
void FFakeShadowModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FFakeShadowModule, FakeShadow)