...
#define LOCTEXT_NAMESPACE "FSimpleInputModule"

void FSimpleInputModule::StartupModule()
{
...
void FSimpleInputModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FSimpleInputModule, SimpleInput)