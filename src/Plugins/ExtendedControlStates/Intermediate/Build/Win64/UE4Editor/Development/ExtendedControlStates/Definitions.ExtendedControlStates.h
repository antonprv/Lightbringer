#undef EXTENDEDCONTROLSTATES_API
...
#define UE_TARGET_NAME LightbringerEditor
#define UE_MODULE_NAME "ExtendedControlStates"
#define UE_PLUGIN_NAME "ExtendedControlStates"
...
#define EXTENDEDCONTROLSTATES_API DLLEXPORT
