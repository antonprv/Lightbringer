...
ATestPawn::ATestPawn()
{
    ...
    //    nullptr, TEXT("InputActionData'/Game/Blueprints/Dev/Input/"
...
//
//void ATestPawn::MoveFowrard(const float& Value)
//{
...
//}
//
//void ATestPawn::MoveRight(const float& Value)
//{
//    if (!bIsPossessed) return;
//
...
//    const FName& AxisName, const ESimpleInputAxisType& AxisType, const float& Value)
//{
